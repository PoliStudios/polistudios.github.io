...
<main class="flex-grow-1 container mx-auto my-3">
	...
	<footer class="d-flex justify-content-center align-items-center bg-success p-3 mt-3">
		<address class="my-2">MikeSJ</address>
	</footer>
</body>
</html>